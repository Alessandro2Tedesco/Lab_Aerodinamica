...
r1 = Centro - Estremo_1;        % Calcolo r1 (congiungente punto indotto - estremo 1)
theta_1 = atan2(r1(2), r1(1));  % Calcolo theta_1 (angolo che la congiungente r1 forma con l'asse x locale)

r2 = Centro - Estremo_2;        % Calcolo r1 (congiungente punto indotto - estremo 2)
theta_2 = atan2(r2(2), r2(1));  % Calcolo theta_2 (angolo che la congiungente r2 forma con l'asse x locale)
